...
/** Stacked mail + WhatsApp FABs (bottom-right). */
export default function ContactFloats() {
  return (
    <div className="contact-floats notranslate" translate="no" aria-label="Quick contact">
      <a
        href={CONTACT_MAILTO}
        className="contact-float contact-float--mail"
      ...
      <a
        href={WHATSAPP_URL}
        className="contact-float contact-float--wa"
        target="_blank"
