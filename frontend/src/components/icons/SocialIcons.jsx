const icons = {
  ...
  linkedin: (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M6.3 9.3H3.6V20h2.7V9.3zM4.95 4C4 4 3.3 4.7 3.3 5.6s.7 1.6 1.65 1.6 1.65-.7 1.65-1.6S5.9 4 4.95 4zM20.4 12.7c0-2.5-1.3-4.1-3.6-4.1-1.5 0-2.3.8-2.7 1.5h-.1V9.3h-2.6c0 .6 0 10.7 0 10.7h2.7v-6c0-.3 0-.6.1-.8.3-.6.9-1.2 1.9-1.2 1.3 0 1.9 1 1.9 2.5v5.5H20.4v-5.8z" />
    </svg>
  ),
  spotify: (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
